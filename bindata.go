...
func include_buildpack_bash() (*asset, error) {
	...
	info := bindata_file_info{name: "include/buildpack.bash", size: 2917, mode: os.FileMode(420), modTime: time.Unix(1420918633, 0)}
...
func include_cedarish_txt() (*asset, error) {
	...
	info := bindata_file_info{name: "include/cedarish.txt", size: 8, mode: os.FileMode(420), modTime: time.Unix(1420919547, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
...
func include_herokuish_bash() (*asset, error) {
	...
	info := bindata_file_info{name: "include/herokuish.bash", size: 2222, mode: os.FileMode(420), modTime: time.Unix(1420918633, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
